 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "api.timewriter.soap.nl", wsdlLocation = "http://localhost:8080/wsdl/timewriterapi.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("api.timewriter.soap.nl", "HelloWorldService");
     ...
     * 
     * @return
     *     returns HelloWorldServicePort
     */
    @WebEndpoint(name = "HelloWorldServicePort")
    public HelloWorldServicePort getHelloWorldServicePort() {
        return super.getPort(new QName("api.timewriter.soap.nl", "HelloWorldServicePort"), HelloWorldServicePort.class);
    }
    ...
    public HelloWorldServicePort getHelloWorldServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("api.timewriter.soap.nl", "HelloWorldServicePort"), HelloWorldServicePort.class, features);
    }
